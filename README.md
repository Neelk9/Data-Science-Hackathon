# Machine learning Cryptocurrency Trading Bot


## Introduction
The machine learning behind this bot is a LSTM Recurrent Neural Network which uses immediate information from the past to predict whether a cryptocurrency will go up or down in the near future.

Our TradeBot will then use this model as an advisor to make its BUY/SELL/HOLD decision.
